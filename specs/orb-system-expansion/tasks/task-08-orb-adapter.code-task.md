...
## Background
The OrbSpawner needs a way to instantiate GenericOrb scenes from OrbData resources. OrbAdapter provides a static factory method that creates a GenericOrb and configures it with OrbData.
...
- specs/orb-system-expansion/plan.md (Step 8)
- scripts/generic_orb.gd (set_orb_data method)
...
## Dependencies
- task-01-generic-orb-collision (requires set_orb_data method on GenericOrb)

## Implementation Approach
1. TDD: Write test_create_orb_from_data_returns_generic_orb
2. TDD: Write test_created_orb_has_orb_data_set
3. TDD: Write test_created_orb_in_orbs_group
4. Implement OrbAdapter to pass all tests
...
4. **Null Safety**
   - Given null orb_data
   - When create_orb_from_data() is called
   - Then null is returned (or assertion fails gracefully)
